    ...
    return (
        <div className='relative flex flex-col lg:flex-row items-start justify-between'>
            ...
            <div className='relative flex flex-col md:flex-row items-start justify-between'>
                <div className='w-full md:w-[60%] lg:w-1/2  px-6 md:px-16 lg:px-32 pt-10 lg:pt-28'>
                    ...
                    <div className='relative'>
                        ...
                        <p className='text-[#636571] text-sm lg:text-base w-full'>
                            Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                            Aenean commodo ligula eget dolor. Aenean massa. Cum sociis
                            natoque penatibus et magnis dis parturient.
                        </p>
                        <img src={line} alt="" className='w-4 md:w-5 lg:w-6 absolute right-[41%] top-[36%] lg:right-[40%] lg:top-[40%] -z-10' />
                    </div>
                </div>


                <div className='relative bg-[#F1F8FF] w-full md:w-[40%] md:h-[300px] lg:h-auto lg:w-1/2 mt-10 md:mt-0 flex justify-center md:justify-end'>
                    <img src={home} alt="" className='w-[80%] lg:w-[65%]' />
                    <div className='absolute left-[270px] top-[125px] pl-5 pr-8 pt-4 pb-2 bg-[#ffffff83] rounded-lg shadow hidden lg:block'>
            ...
            <div className='lg:absolute lg:left-[18%] lg:top-[70%] px-6 md:px-16 w-[100%] lg:w-auto my-10'>
                <div className='px-6 py-5 flex flex-col lg:flex-row items-start lg:items-end gap-8 bg-white shadow-md rounded-lg '>
